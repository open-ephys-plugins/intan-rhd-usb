...
DeviceEditor::DeviceEditor (GenericProcessor* parentNode,
                            DeviceThread* board_)
    : VisualizerEditor (parentNode, "Intan USB", 320), board (board_)
{
    canvas = nullptr;
    ...
    bandwidthInterface->setBounds (80, 59, 80, 50);
    ...
    audioLabel->setBounds (170, 22, 75, 15);
    ...
    dacTTLButton->setBounds (260, 30, 60, 18);
    ...
    dacHPFlabel->setBounds (255, 50, 60, 15);
    ...
    ttlSettleLabel->setBounds (255, 85, 70, 15);
...
HeadstageOptionsInterface::HeadstageOptionsInterface (DeviceThread* board_,
                                                      ...
                                                      int hsNum) : isEnabled (false), board (board_), editor (editor_)
{
    switch (hsNum)
    {
        case 0:
...
ClockDivideInterface::ClockDivideInterface (DeviceThread* board_,
                                            DeviceEditor* editor_) : name ("Clock"), lastDivideRatioString ("1"), board (board_), editor (editor_), actualDivideRatio (1)
